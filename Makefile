...
CHPEG_HEADER_FILES=chpeg_api.h \
		   mem.h opcodes.h bytecode.h chpeg_bytecode.h util.h parser.h compiler.h
CHPEG_SOURCE_FILES=mem.c opcodes.c bytecode.c chpeg_bytecode.c util.c parser.c compiler.c
