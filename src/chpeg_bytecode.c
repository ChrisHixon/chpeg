...
CHPEG_DEF const ChpegByteCode chpeg_bytecode = {
  ...
  /*    42 <-:Definition 9 (def:Definition) []> {}  */ CHPEG_INST(CHPEG_OP_IFAIL, 1),
  ...
  /*    55 <-:Definition 22 (def:Choice) []> {}     */ CHPEG_INST(CHPEG_OP_IFAIL, 2),
  ...
  /*    62 <-:Definition 30 (def:Sequence) []> {}   */ CHPEG_INST(CHPEG_OP_IFAIL, 3),
  ...
  /*    73 <-:Definition 34 (def:Predicate) []> {}  */ CHPEG_INST(CHPEG_OP_IFAIL, 4),
  ...
  /*    84 <-:Definition 42 (def:Repeat) []> {}     */ CHPEG_INST(CHPEG_OP_IFAIL, 5),
  ...
  /*   129 <-:Definition 50 (def:Primary) []> {}    */ CHPEG_INST(CHPEG_OP_IFAIL, 6),
  ...
  /*   136 <-:Definition 70 (def:Options) []> {}    */ CHPEG_INST(CHPEG_OP_IFAIL, 7),
  ...
  /*   145 <-:Definition 73 (def:Identifier) []> {L} */ CHPEG_INST(CHPEG_OP_IFAIL, 8),
  ...
  /*   181 <-:Definition 77 (def:Literal) []> {S}   */ CHPEG_INST(CHPEG_OP_IFAIL, 9),
  ...
  /*   197 <-:Definition 90 (def:CharClass) []> {S} */ CHPEG_INST(CHPEG_OP_IFAIL, 10),
  ...
  /*   218 <-:Definition 97 (def:CharRange) []> {}  */ CHPEG_INST(CHPEG_OP_IFAIL, 11),
  ...
  /*   234 <-:Definition 105 (def:Char) []> {}      */ CHPEG_INST(CHPEG_OP_IFAIL, 12),
  ...
  /*   240 <-:Definition 111 (def:EscChar) []> {L}  */ CHPEG_INST(CHPEG_OP_IFAIL, 13),
  ...
  /*   265 <-:Definition 114 (def:OctChar) []> {L}  */ CHPEG_INST(CHPEG_OP_IFAIL, 14),
  ...
  /*   273 <-:Definition 120 (def:PlainChar) []> {L} */ CHPEG_INST(CHPEG_OP_IFAIL, 15),
  ...
  /*   277 <-:Definition 125 (def:PredOp) []> {L}   */ CHPEG_INST(CHPEG_OP_IFAIL, 16),
  ...
  /*   281 <-:Definition 127 (def:RepOp) []> {L}    */ CHPEG_INST(CHPEG_OP_IFAIL, 17),
  ...
  /*   285 <-:Definition 129 (def:Dot) []> {L}      */ CHPEG_INST(CHPEG_OP_IFAIL, 18),
  ...
  /*   314 <-:Definition 131 (def:S) []> {I}        */ CHPEG_INST(CHPEG_OP_IFAIL, 19)
  },
  .num_strings = 25,
